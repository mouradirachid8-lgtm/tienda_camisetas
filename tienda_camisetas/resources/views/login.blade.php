...
<body class="flex flex-col items-center justify-center h-screen bg-whait">
    ...
    <div class="w-full max-w-lg bg-orange-500 p-10 rounded-lg shadow-lg border-4 border-blue-600 mt-6">
        ...
        <p class="text-lg text-center mb-6">¿Es tu primera vez? <a href="#" class="text-blue-800 font-semibold hover:underline">Regístrate</a></p>
