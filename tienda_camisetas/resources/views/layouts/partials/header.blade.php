        ...
        <div class="flex gap-6 items-center ml-auto">
            ...
            @auth
                <form action="{{ route('logout') }}" method="POST" class="inline">
                    @csrf
                    <button type="submit"
                        class="flex items-center space-x-2 text-red-500 hover:text-red-700 transition-colors">
            ...
            @else
                <a href="{{ route('login') }}"
                    class="flex items-center space-x-2 text-blue-500 hover:text-blue-700 transition-colors">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd"
                            d="M3 3a1 1 0 011-1h12a1 1 0 011 1v3a1 1 0 11-2 0V4H4v12h12v-2a1 1 0 112 0v3a1 1 0 01-1 1H4a1 1 0 01-1-1V3z"
                            clip-rule="evenodd"></path>
                        <path fill-rule="evenodd"
